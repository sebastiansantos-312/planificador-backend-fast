...
def create_task_by_email(db: Session, data: schemas.TaskCreateByEmail):
    """
    Crea una tarea resolviendo usuario por email y materia por nombre.
    ...
    por nombre (materias son globales), luego crea la tarea con los IDs correctos.
